...
export interface PositionWhereInput {
  ...
  moduleId_not?: Maybe<String>;
  moduleId_in?: Maybe<String[] | String>;
  moduleId_not_in?: Maybe<String[] | String>;
  moduleId_lt?: Maybe<String>;
  moduleId_lte?: Maybe<String>;
  moduleId_gt?: Maybe<String>;
  moduleId_gte?: Maybe<String>;
  moduleId_contains?: Maybe<String>;
  moduleId_not_contains?: Maybe<String>;
  moduleId_starts_with?: Maybe<String>;
  moduleId_not_starts_with?: Maybe<String>;
  moduleId_ends_with?: Maybe<String>;
  moduleId_not_ends_with?: Maybe<String>;
  timestamp?: Maybe<Int>;
  ...
  altitude_not?: Maybe<String>;
  altitude_in?: Maybe<String[] | String>;
  altitude_not_in?: Maybe<String[] | String>;
  altitude_lt?: Maybe<String>;
  altitude_lte?: Maybe<String>;
  altitude_gt?: Maybe<String>;
  altitude_gte?: Maybe<String>;
  altitude_contains?: Maybe<String>;
  altitude_not_contains?: Maybe<String>;
  altitude_starts_with?: Maybe<String>;
  altitude_not_starts_with?: Maybe<String>;
  altitude_ends_with?: Maybe<String>;
  altitude_not_ends_with?: Maybe<String>;
  batt?: Maybe<Int>;
  batt_not?: Maybe<Int>;
  batt_in?: Maybe<Int[] | Int>;
  batt_not_in?: Maybe<Int[] | Int>;
  batt_lt?: Maybe<Int>;
  batt_lte?: Maybe<Int>;
  batt_gt?: Maybe<Int>;
  batt_gte?: Maybe<Int>;
  ...
  satelites?: Maybe<Int>;
  satelites_not?: Maybe<Int>;
  satelites_in?: Maybe<Int[] | Int>;
  satelites_not_in?: Maybe<Int[] | Int>;
  satelites_lt?: Maybe<Int>;
  satelites_lte?: Maybe<Int>;
  satelites_gt?: Maybe<Int>;
  satelites_gte?: Maybe<Int>;
  cowAt?: Maybe<CowWhereInput>;
  createdAt?: Maybe<DateTimeInput>;
  createdAt_not?: Maybe<DateTimeInput>;
  createdAt_in?: Maybe<DateTimeInput[] | DateTimeInput>;
  createdAt_not_in?: Maybe<DateTimeInput[] | DateTimeInput>;
...
export interface CowCreateInput {
  ...
  location: String;
  myId: String;
  positions?: Maybe<PositionCreateManyWithoutCowAtInput>;
}
...
export interface PositionCreateManyWithoutCowAtInput {
  create?: Maybe<
    PositionCreateWithoutCowAtInput[] | PositionCreateWithoutCowAtInput
  >;
  connect?: Maybe<PositionWhereUniqueInput[] | PositionWhereUniqueInput>;
}

export interface PositionCreateWithoutCowAtInput {
  id?: Maybe<ID_Input>;
  moduleId: String;
  timestamp: Int;
  lat: String;
...
export interface CowUpdateInput {
  ...
  location?: Maybe<String>;
  myId?: Maybe<String>;
  positions?: Maybe<PositionUpdateManyWithoutCowAtInput>;
}
...
export interface PositionUpdateManyWithoutCowAtInput {
  create?: Maybe<
    PositionCreateWithoutCowAtInput[] | PositionCreateWithoutCowAtInput
  >;
  ...
  update?: Maybe<
    | PositionUpdateWithWhereUniqueWithoutCowAtInput[]
    | PositionUpdateWithWhereUniqueWithoutCowAtInput
  >;
  upsert?: Maybe<
    | PositionUpsertWithWhereUniqueWithoutCowAtInput[]
    | PositionUpsertWithWhereUniqueWithoutCowAtInput
  >;
...
export interface PositionUpdateWithWhereUniqueWithoutCowAtInput {
  where: PositionWhereUniqueInput;
  data: PositionUpdateWithoutCowAtDataInput;
}

export interface PositionUpdateWithoutCowAtDataInput {
  moduleId?: Maybe<String>;
  timestamp?: Maybe<Int>;
  lat?: Maybe<String>;
  lon?: Maybe<String>;
...
export interface PositionUpsertWithWhereUniqueWithoutCowAtInput {
  where: PositionWhereUniqueInput;
...
export interface CowCreateOneWithoutPositionsInput {
  create?: Maybe<CowCreateWithoutPositionsInput>;
  connect?: Maybe<CowWhereUniqueInput>;
}

export interface CowCreateWithoutPositionsInput {
  id?: Maybe<ID_Input>;
  height: Float;
  weight: Float;
  heal: Int;
...
export interface PositionUpdateInput {
  ...
  temperature?: Maybe<Int>;
  satelites?: Maybe<Int>;
  cowAt?: Maybe<CowUpdateOneRequiredWithoutPositionsInput>;
}

export interface CowUpdateOneRequiredWithoutPositionsInput {
  create?: Maybe<CowCreateWithoutPositionsInput>;
  update?: Maybe<CowUpdateWithoutPositionsDataInput>;
  upsert?: Maybe<CowUpsertWithoutPositionsInput>;
  connect?: Maybe<CowWhereUniqueInput>;
}

export interface CowUpdateWithoutPositionsDataInput {
  height?: Maybe<Float>;
  weight?: Maybe<Float>;
  heal?: Maybe<Int>;
  herd?: Maybe<HerdUpdateOneWithoutCowsInput>;
...
export interface CowUpsertWithoutPositionsInput {
...
export interface PositionPromise extends Promise<Position>, Fragmentable {
  id: () => Promise<ID_Output>;
  moduleId: () => Promise<String>;
  timestamp: () => Promise<Int>;
  lat: () => Promise<String>;
  lon: () => Promise<String>;
  altitude: () => Promise<String>;
  batt: () => Promise<Int>;
  speed: () => Promise<Int>;
  temperature: () => Promise<Int>;
  satelites: () => Promise<Int>;
  cowAt: <T = CowPromise>() => T;
  createdAt: () => Promise<DateTimeOutput>;
  updatedAt: () => Promise<DateTimeOutput>;
}
